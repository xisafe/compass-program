...
<table border="0" class="ruleslist" cellspacing="0" cellpadding="4" width="100%">
  <tr>
    ...
    <td width="10%" align="center" class="boldbase"><b>%s</b></td>
  </tr>
EOF
,
_('User'),
...
#CLIENT_LIST,r3,80.108.92.192:49542,192.168.0.180,68830,67705,Wed Feb 23 07:56:26 2005,1109141786
  ...
  <tr class="$oddeven">
    ...
    <td>
      <form method="post" action="$self" style="width:100px;display:block;margin:0px auto;">
        <input  type="image" src="/images/cut.png"  name="submit" title="%s">
