...
sub init_data() {
    ...
    $extraheader = '<link rel="stylesheet" type="text/css" href="/include/add_list_base.css" />
                    ...
                    <script language="JavaScript" src="/include/logs_connctrl.js"></script>';
...
sub  do_action() {
    ...
    if ( $action eq 'load_data' && $panel_name eq 'list_panel' ) {
        ...
        ($errormessage,$notemessage) = &importLog(\%par,'connctrl');
        &show_page();
    }       
