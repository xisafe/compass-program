...
sub init_data(){
    ...
    $extraheader = '<script language="JavaScript" src="/include/idps_protocol_reduction_init.js"></script>
                    <script language="JavaScript" src="/include/idps_protocol_reduction_list.js"></script>
...
;
    ...
    printf <<END
                ...
                <td  align='left'><input class='submitbutton' type='button' id="btn_confirm" name='ACTION' value='确定' onclick="doaction_confirm();"/></td>
                </form>
            </tr>
        </table>
        </div>
...
sub config_add_item_data() {
    ...
    push(@display_add_config_data, \%hash);
     ...
     my %hash = (
        ...
        "value" => "",
        "is_in_list" => 1, #配置其是否在规则列表中显示出来，0为不显示，不等于0表示显示
        "width" => "26%",#此字段只有在is_in_list字段不等于0时可用，并且所有的启用了的此字段加起来为80%最适宜，可微调
        "class" => "",
    );
    push(@display_add_config_data, \%hash);
...
sub display_rule_list() {
    ...
    <div id= "detailDiv" style= "width:100%;margin-left:300px; height:auto; position:absolute;display:none; top:150px; left:0px; filter:progid:DXImagesTransform.Microsoft.Alpha(style=3,opacity=25,finishOpacity=75); opacity:0.6; left:0; width:50%; z-index:10000;"> 
    <div class="fd_box">
                    ...
                    <tr>
                        <td id="rule-list-foot-td" colspan="$colspan">
                            <span class="paging-tools">
                                ...
                                <span class="paging-text">第<input id="current-page" class="paging-tool-text" type="text" disabled />页</span>
