...
my $blue_class="class='odd_thin blue bold' style='background-color:#c8e6ed;color:#2898c2;cursor:pointer;'";
...
my $name = _('Network status');
&showhttpheaders();
&openpage($name, 1,'<script language="JavaScript" type="text/javascript" src="/include/netstatus.js"></script>');
display();
