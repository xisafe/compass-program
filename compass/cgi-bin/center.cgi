...
<link rel="stylesheet" type="text/css" href="/include/eidt_passwd_body.css" />
    ...
    <div id= "eidt_passwd_aaa" style="width:100%;height:100%;">
        <div id= "eidt_passwd_bbb" style="dispaly:none;">
            <div id="eidt_passwd_body" class="popup-mesg-box-body mesg-box-s" style="margin:0px auto;line-height: 30px;text-align: center;display:none; width:500px;">
                <div class=modifypsd-header><span>修改密码</span></div>
                <div id="have_to_mesg"></div>
                ...
                <table>
                    <tr class="modifypsd-original env1">
                        <td class="modifypsd-left"><span>原始密码*</span></td>                
                        <td class="modifypsd-right"><input type="password" id="primary_passwd" name="primary_passwd"/></td>    
                    </tr>
            
                    <tr class="modifypsd-new odd1">
                        <td class="modifypsd-left"><span>新</span><span style="margin-left:6px;">密</span><span style="margin-left:6px;">码*</span></td>             
                        <td class="modifypsd-right"><input type="password" id="new_passwd" name="new_passwd"/></td>
                    </tr>
            
                    <tr class="modifypsd-newagain env1">
                        <td class="modifypsd-left"><span>确认密码*</span></td>            
                        <td class="modifypsd-right"><input type="password" id="confirm_passwd" name="confirm_passwd"/></td>
                    </tr>
                </table>    
                    <div style="color: red;"> </div>
            
                    <div class="add-panel-footer" style="height: 34px;line-height: 34px;">
                        <input type="submit" class="add-panel-form-button" id="submit" value="确认"/>
