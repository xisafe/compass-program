...
sub init_data(){
    ...
    $extraheader = '<link rel="stylesheet" type="text/css" href="/include/add_list_base.css" />
                    ...
                    <script language="JavaScript" src="/include/virus_log.js"></script>';
...
sub query_suggestion($id) {
    ...
    #             %ret_data->{'mesg'} = $arrTemp[$i]->{'virus_md5'}
          
    #         }
     %ret_data->{'mesg'} = $arrTemp[$par{'line_id'}]->{'virus_md5'};
    ...
    # my $content;
    # $content = &load_data_extend();
    # my $record = $content.detail_data[$id];
    # print $record;
}
