...
sub init_data(){
    ...
    $logs               = 'logs_event';
    $logs_event         ='/var/log/eventwarn.log';
    $sid_info           = '/usr/local/bin/get_sid_info.py';
    $logname          ="eventwarn.log";
    ...
    $extraheader = '<link rel="stylesheet" type="text/css" href="/include/add_list_base.css" />
                    ...
                    <script language="JavaScript" src="/include/logs_event.js"></script>';
...
sub do_action() {
    ...
    if ( $action eq 'load_data' && $panel_name eq 'list_panel' ) {
        ...
        ($errormessage,$notemessage) = &importLog(\%par,'eventwarn.log');
        &show_page();
    }       
...
sub clearLogForPass(){
    my %ret_data;
    my $filestr = 'clear='.'eventwarn.log';
