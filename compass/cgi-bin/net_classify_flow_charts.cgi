...
sub init_data(){
    ...
    $extraheader = '<link rel="stylesheet" type="text/css" href="/include/add_list_base.css" />
                    ...
                    <script language="JavaScript" src="/include/net_clssify_flow_charts.js"></script>';
...
sub display_list_div() {
    printf<<EOF
    <div id="panel_flow_list_for_net" style="width: 96%;margin: 20px auto;"></div>
...
;
    ...
    <form name='FLOW_ENABLE_FORM' method='post' action='$ENV{SCRIPT_NAME}'>
        ...
        <div id="net_flow_chart" style=""></div>
...
sub load_data() {
    ...
    my $ldate  = ($par{'islive'} == 1) ? '--ldate 0' : '--ldate '.$par{'ldate'};
    my $hdate  = ($par{'islive'} == 1) ? '--hdate 0' : '--hdate '.$par{'hdate'};
