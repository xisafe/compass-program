...
var ass_url = "/cgi-bin/keywordfilter_log.cgi";
...
var list_panel_config = {
    ...
    panel_header: [                 /* ***必填***，控制数据的加载以及表头显示 */
        {
            ...
            enable: true,
            type: "text",
            title: "关键字(<font class='tb_k'>K</font>)/命令(<font class='tb_cmd'>C</font>)",
            name: "keyword",
            td_class:"align-center",
            width: "10%"
        }, {
    ...
    top_widgets: [                          /* ===可选===，在面板左上角的操作控件，目前按钮位置不能调整 */

        {
            ...
            name: "clearLog",
            type: "link_button",
            //href: "/cgi-bin/keywordfilter_log.cgi?ACTION=clearLog",
            button_icon: "delete.png",
            button_text: "清空日志",
            functions: {
...
function import_panel_extendrender(argument) {
    ...
    .wrap('<form enctype="multipart/form-data" method="post" action="/cgi-bin/keywordfilter_log.cgi" style="display:inline-block"></form>');
