...
PagingHolder.prototype.init_panel_config = function( panel_config ) {
    ...
    /* 定义面板是否可拖拽 */
    paging_holder.panel_config.is_panel_draggable = panel_config.is_panel_draggable !== undefined ? panel_config.is_panel_draggable : false;
...
PagingHolder.prototype.init_control_checkbox = function() {
    ...
    if( $( control_checkbox_selector ).length > 0 ) {
        ...
        //     $( control_checkbox_selector )[0].checked = $( control_checkbox_selector )[0].checked == true ? false : true ;
        // });
        $( control_checkbox_selector )/*.parent()*/.click(function(){
            // $( control_checkbox_selector )[0].checked = $( control_checkbox_selector )[0].checked == true ? false : true ;
