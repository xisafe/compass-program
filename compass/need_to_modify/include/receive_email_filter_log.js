 ...
 */
var ass_url = "/cgi-bin/receive_email_filter_log.cgi";
...
var list_panel_config = {
    url: ass_url,
    check_in_id: "email_filter_log_panel",
    panel_name: "email_filter_log_panel",
    ...
    panel_header: [{
        ...
        type: 'text',
        title: "收件人邮箱",
        name: "RECIPIENT_EMAIL",                            // name: "FILTER_TYPE",
        column_cls: "align-center",
        width: "20%"
    }, {
        enable: true,
    ...
    top_widgets: [{
        ...
        type: "link_button",
        id: "export_log_id",
        href: "/cgi-bin/receive_email_filter_log.cgi?ACTION=export_data",
...
$( document ).ready(function() {
    ...
    $("#list_panel_id_for_email_filter_log_panel a>button").css({"width":"100px","height":"30px"});
...
function do_request( sending_data, onreceived ) {
    $.ajax({
        type: 'POST',
        url: "/cgi-bin/receive_email_filter_log.cgi",
        data: sending_data,
        dataType: 'json',
        async: false,
