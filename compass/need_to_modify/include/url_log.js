...
var end_time_minute = '';
var successMesg = '';
var ass_url = "/cgi-bin/url_log.cgi";
...
var importLog_panel_config = {
    ...
    check_in_id: "importLog_panel",
    /* ***必填***，确定面板挂载在哪里 */
    panel_name: "importLog_panel",
...
function import_panel_extendrender(argument) {
    ...
    $("#export_log").append('<input type="hidden" name="ACTION" value="down_log" style="width:0;height:0;">')
        .wrap('<form enctype="multipart/form-data" method="post" action="/cgi-bin/url_log.cgi" style="display:inline-block"></form>');
