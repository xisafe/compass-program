...
var ass_url = "/cgi-bin/logs_user_secretauth.cgi";
var search_date = '';
...
function searchItem() {
    if ($('#export_log')) {
        $("#export_log").attr('value',$('#search_date').val());
...
function import_panel_extendrender(argument) {
    ...
    .wrap('<form enctype="multipart/form-data" method="post" action="/cgi-bin/logs_user_secretauth.cgi" style="display:inline-block"></form>');
}
