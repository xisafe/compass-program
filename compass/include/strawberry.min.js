...
BaseTool.prototype = {
    ...
    printView: function() {
        ...
        if (this.isChrome || this.isGecko) {
            ...
            c[a++] = "<html>";
            c[a++] = "<head>";
            c[a++] = '<link href="/include/flowPath.css" type="text/css" rel="stylesheet" />';
...
ModeTool.prototype = {
    ...
    createBaseMode: function(o, f, a, i, e, l) {
        ...
        t = u.createElement("div"),
		  mac = u.createElement("div"),
		  host_name = u.createElement("div"),
		  remark = u.createElement("div"),
		  alise = u.createElement("div"),
		  service_type= u.createElement("div"),
		...
		alise.style.display = "none";
		service_type.style.display = "none";
		
        j.appendChild(t);
        j.appendChild(q);
		j.appendChild(mac);
		j.appendChild(host_name);
		j.appendChild(remark);
		j.appendChild(alise);
		j.appendChild(service_type);
        ...
        p.setClass(t, "title");
		p.setClass(mac, "mac");
		p.setClass(host_name, "host_name");
		p.setClass(remark, "remark");
		p.setClass(alise, "alise");
		p.setClass(service_type, "service_type");
        ...
        s.id = "backImg" + i;
		mac.id = "mac"+i;
		host_name.id = "host_name"+i;
		remark.id = "remark"+i;
		alise.id = "alise"+i;
		service_type.id = "service_type"+i;
    ...
    showPointerId: function(i) {
        ...
        k = e.offsetHeight,
        c = e.offsetWidth;
		var inner_text = $id("title" + i).innerHTML;
		var inner_width = 0;
		for(var index=0;index<inner_text.length;index++)
		{
			if(inner_text.charCodeAt(index)>=255)
			{
				inner_width+=3;
			}else{
				inner_width+=1;
		...
		$id("title" + i).style.width = inner_width*4+"px";
...
var ControlTool = com.xjwgraph.ControlTool = function(b) {
	...
	a.inputMac = $id("inputMac");
    d(a.inputMac);
	
	a.inputHost_name = $id("inputHost_name");
    d(a.inputHost_name);
	
	a.inputRemark = $id("inputRemark");
    d(a.inputRemark);
	
	a.inputAlise = $id("inputAlise");
    d(a.inputAlise);
	
	a.inputService_type = $id("inputService_type");
    d(a.inputService_type);
};
ControlTool.prototype = {
    ...
    print: function(d) {
        ...
        e = $id("title" + d),
		mac = $id("mac" + d),
		host_name = $id("host_name" + d);
		remark = $id("remark" + d);
		alise = $id("alise" + d);
		service_type = $id("service_type" + d);
		
        a = this;
        a.indexId = d;
        
		if(remark.innerHTML　!= "undefined" &&　remark.innerHTML)
		{
			a.inputTitle.innerHTML = remark.innerHTML;
		}else{
			a.inputTitle.innerHTML = "未知";
		}
		
		if(mac.innerHTML　!= "undefined" && mac.innerHTML)
		{
			a.inputMac.innerHTML = mac.innerHTML;
		}else{
			a.inputMac.innerHTML = "未知";
		}
		
		if(host_name.innerHTML　!= "undefined" && host_name.innerHTML)
		{
			a.inputHost_name.innerHTML = host_name.innerHTML;
		}else{
			a.inputHost_name.innerHTML = "未知";
		}
    }
};
com.xjwgraph.Global = {};
...
var ModeXML = com.xjwgraph.ModeXML = function() {
	...
	b.mac     = a.getSonNode(b.modeDiv, "mac");
    b.host_name = a.getSonNode(b.modeDiv, "host_name");
	b.remark = a.getSonNode(b.modeDiv, "remark");
	b.alise = a.getSonNode(b.modeDiv, "alise");
	b.service_type = a.getSonNode(b.modeDiv, "service_type");
};
    ...
    setAttribute: function(b, c) {
        ...
        if (b == "backImgSrc") {
            a.backImg.src = c
             ...
             a.host_name.innerHTML = c
        }else  if (b == "remark") {
             a.remark.innerHTML = c
        }else  if (b == "alise") {
             a.alise.innerHTML = c
        }else  if (b == "service_type") {
             a.service_type.innerHTML = c
        }else {
            if (b == "top") {
...
BeanXML.prototype = {
    ...
    viewTextXml: function(b) {
        ...
        d[a++] = "<html>";
        d[a++] = "<head>";
        d[a++] = '<link href="/include/flowPath.css" type="text/css" rel="stylesheet" />';
