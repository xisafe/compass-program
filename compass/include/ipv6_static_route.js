...
var ass_url = "/cgi-bin/ipv6_static_route.cgi";
...
var add_panel_config = {
    ...
    items_list: [                   /* ***必填***，确定面板中有哪些规则，不填什么都没有 */
        {
            title: "目标IP",          /* **必填**，每一行前面的提示文字，不填没有提示，影响用户体验 */
            ...
            sub_items: [            /* **必填**，确定此行有哪些字段，不填什么都没有 */
                {
                    ...
                    check: {                /* ==可选==，如果要对字段进行检查，填写此字段 */
                        ...
                        check: 'ipv6_mask',     /* **必填**，检测类型，具体支持哪些种类型参见ChinArk_form.js文件源码 */
