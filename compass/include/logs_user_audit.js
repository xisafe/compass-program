...
/*定义全局变量*/
var ass_url = "/cgi-bin/logs_user_audit.cgi";
var search_date = '';
...
function import_panel_extendrender(argument) {
    ...
    .wrap('<form enctype="multipart/form-data" method="post" action="/cgi-bin/logs_user_audit.cgi" style="display:inline-block"></form>');
}
